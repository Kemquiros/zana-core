...
if __name__ == "__main__":
    ...
    chronicler.save_diary_entry(
        ["Iniciada integración de KoruOS", "Refactorizado orquestador a ReAct"]
    )
    chronicler.extract_procedural_skill(
        "Deploy Koru Body", ["setup_monorepo", "build_proto", "start_server"]
    )
