...
from cli.tui.aeon_sigil import AeonArchetype, AeonProfile, ARCHETYPE_COLORS, ARCHETYPE_LABELS
...
QUESTIONS = [
    ...
    },
    {
        ...
        "options": [
            ...
            ("Estudio los patrones del clima para predecir el impacto", AeonArchetype.ORACULO),
    ...
    },
    {
        ...
        "options": [
            ...
            ("'Las personas que encuentres son el verdadero mapa'", AeonArchetype.MAREA),
    ...
    },
    {
        ...
        "options": [
            ...
            ("La desconexión entre personas que podrían colaborar", AeonArchetype.MAREA),
            ("La incapacidad de predecir consecuencias de segunda vuelta", AeonArchetype.ORACULO),
            ("La falta de sistemas que sobrevivan a sus creadores", AeonArchetype.FORJA),
        ],
    },
    {
        "id": "q5",
        ...
        "options": [
            ...
            ("Preguntas — para que alguien en la Tierra las piense", AeonArchetype.VACIO),
...
def run_resonance_test(profile: AeonProfile) -> AeonArchetype:
    ...
    scores: dict[AeonArchetype, int] = {a: 0 for a in AeonArchetype if a != AeonArchetype.UNKNOWN}
...
def _print_result(archetype: AeonArchetype, profile: AeonProfile) -> None:
    ...
    content.append(f"Tu Aeón es del arquetipo ", style="white")
...
def _show_sigil_preview(archetype: AeonArchetype, profile: AeonProfile) -> None:
    ...
    from cli.tui.aeon_sigil import _FRAME_BUILDERS, AeonStage
    pc, ac = ARCHETYPE_COLORS[archetype]
    ...
    console.print(f"  [dim]Crece con cada conversación.[/dim]")
    console.print()
