...
def start(
    ...
    if foreground:
        from zana.core.satellite.runner import run

        run()
        return

    proc = subprocess.Popen(
        [sys.executable, "-m", "zana.core.satellite.runner"],
...
def users() -> None:
    ...
    from zana.core.multiuser import UserRegistry
