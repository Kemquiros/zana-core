...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../cli/cli/tui')))
...
def test_archetypes_exist():
    ...
    expected = [
        "KETER", "BINAH", "CHOKHMAH", "CHESED", "GEVURAH", 
        "TIFERET", "NETZACH", "HOD", "YESOD", "MALKHUT", "DAAT"
    ]
