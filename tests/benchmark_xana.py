...
USO:
    cd xana-core
    python tests/benchmark_xana.py              # run completo
    python tests/benchmark_xana.py --compare    # muestra delta vs run anterior
...
def main():
    ...
    print("─" * 62)
    kpi_table = [
        ("Latency p95",      "< 3s",     "Measure with live xana-core-api"),
