...
def get_vault_files(vault_root: Path) -> list[Path]:
    ...
    for root, dirs, filenames in os.walk(vault_root):
        ...
        for name in filenames:
            ...
            if file_path.suffix.lower() == ".md" and not is_ignored(file_path, vault_root):
...
def cli(reset: bool):
    ...
    console.print(f"[yellow]Embedding and upserting {len(documents)} chunks to ChromaDB...[/yellow]")
    ...
    console.print("[bold green]✅ Embedding pipeline completed successfully![/bold green]")
