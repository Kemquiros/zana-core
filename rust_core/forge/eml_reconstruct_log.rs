[ROUTE:CLAUDE:OPUS]
Handle this with claude-opus-4-6.

Query:
        ZANA ARCHITECT COMMAND: AUTOPOTESIS TRIGGERED.
        Goal: Synthesize a replacement for the failing skill 'eml_reconstruct_log'.
        Current Steps: ['eml(1, x)', 'eml(1, result)', 'eml(1, result)']
        Domain: math
