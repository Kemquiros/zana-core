...
def handshake():
    print("--- 🦾 XANA: HANDSHAKE DE ACTIVACIÓN TOTAL ---")
    ...
    print(f"✅ KALMAN: Inicializado (dim={kf.dim}, uncertainty={kf.get_uncertainty_score():.4f}).")
    ...
    print("XANA ahora opera bajo el ciclo SENSE → RECALL → FEEL → SIMULATE → RESTRICT → ACT → CRYSTALLIZE.")
