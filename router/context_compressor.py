...
class ContextCompressor:
    ...
    def filter_segments(self, segments: List[Dict[str, Any]], embeddings: List[np.ndarray]) -> List[Dict[str, Any]]:
        """
        ...
        for seg, emb in zip(segments, embeddings):
            ...
            if surprise > self.surprise_threshold or self.kf.get_uncertainty_score() > 0.1:
