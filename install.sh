#!/usr/bin/env bash
# 🧠 ZANA Installer v2.8.3 — Sovereign Cognitive Architecture
...
MSG_SUCCESS[en]="ZANA v2.8.5 — INSTALLED SUCCESSFULLY."
...
MSG_SUCCESS[es]="ZANA v2.8.5 — INSTALADA CON ÉXITO."
...
install_core() {
    ...
    echo -e "${CYAN}▶ Deploying ZANA CLI v2.8.5...${RESET}"
