...
MSG_STARTING[en]="Launching configuration protocol (zana start)..."
...
MSG_STARTING[es]="Iniciando protocolo de configuración (zana start)..."
...
MSG_STARTING[pt]="Iniciando protocolo de configuração (zana start)..."
...
MSG_STARTING[fr]="Lancement du protocole de configuration (zana start)..."
...
MSG_STARTING[it]="Avvio del protocollo di configurazione (zana start)..."
...
MSG_STARTING[de]="Konfigurationsprotokoll wird gestartet (zana start)..."
