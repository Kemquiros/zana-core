#!/usr/bin/env bash
# 🧠 ZANA Installer v2.9.2 — Sovereign Cognitive Architecture
...
MSG_SUCCESS[en]="ZANA v2.9.2 — INSTALLED SUCCESSFULLY."
...
MSG_SUCCESS[es]="ZANA v2.9.2 — INSTALADA CON ÉXITO."
...
install_core() {
    ...
    echo -e "${CYAN}▶ Deploying ZANA CLI v2.9.2...${RESET}"
